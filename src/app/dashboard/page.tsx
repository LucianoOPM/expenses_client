            ...
            <TabsContent value="overview" className="space-y-4">
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">$32,456.78</div>
                    <p className="text-xs text-muted-foreground">
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="text-2xl font-bold">$12,775.11</div>
                    <p className="text-xs text-muted-foreground">
              ...
              <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
                ...
                <Card className="col-span-3">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Has realizado 265 movimientos este mes.
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <RecentSales />
                ...
                <Card className="col-span-3">
                  ...
                  <CardContent>
                    <ul className="ml-6 list-disc [&>li]:mt-2">
                      ...
                      <li>
                        Considera automatizar tus ahorros con transferencias
                        programadas.
                      </li>
                      <li>Revisa y cancela suscripciones innecesarias.</li>
                      <li>
                        Busca ofertas y descuentos en tus compras habituales.
                      </li>
                      <li>
                        Planifica tus comidas para reducir gastos en
                        restaurantes.
                      </li>
                    </ul>
                  </CardContent>
